...
namespace SystèmeGestionConsultationPrescriptions.ConsoleTestApp.Tests
{
    ...
    {
        [Fact]
        public void TestDossierMedicalAjoutConsultationDevoirAjouterConsultation()
        {
            // Arrange
        ...
        [Fact]
        public void TestDossierMedicalAjoutTraitementActifDevoirAjouterTraitement()
        {
            // Arrange
            var dossierMedical = new DossierMedical(1, DateTime.Now);
        ...
        [Fact]
        public void TestMedecinGestionPatientsDevoirGererPatients()
        {
            // Arrange
        ...
        [Fact]
        public void TestPrescriptionDefinirPeriodeDevoirCalculerDuree()
        {
            // Arrange
            var prescription = new Prescription();
        ...
        [Fact]
        public void TestDossierMedicalVerifierTraitementsDevoirMettreAJourTraitementsExpires()
        {
            // Arrange
            var dossierMedical = new DossierMedical(1, DateTime.Now);
            var prescription = new Prescription
